...
Smiðr には、キーボードそのものを設計する **Design** モードと、実機に接続してキー割り当てを調整する **Remap** モードがあります。

まだ設計中のキーボードは Design、手元のキーボードを使いながら調整したいときは Remap を使います。

## 基本の流れ

1. プリセットまたはインポートからプロジェクトを作成します。
2. Layout でキーの位置、サイズ、回転を整えます。
3. Matrix で各キーの行・列を割り当てます。
4. Keymap でレイヤーとキーコードを編集します。
