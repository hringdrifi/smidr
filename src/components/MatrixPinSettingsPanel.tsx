...
export const MatrixPinSettingsPanel = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-[var(--bg-panel)] overflow-hidden animate-in fade-in duration-200">
      ...
      <div className="flex-1 min-h-0 overflow-x-auto custom-scrollbar bg-[var(--bg-app)]/20">
        <div className="h-full min-w-[1180px] grid grid-cols-[minmax(820px,1fr)_380px] gap-0">
          ...
          <div className="m-4 ml-0 space-y-3 bg-[var(--bg-app)]/30 px-3 pt-3 pb-2 rounded-lg border border-[var(--border-main)]/30 min-w-0">
