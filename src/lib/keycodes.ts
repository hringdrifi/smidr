...
export const KEYCODES: Keycode[] = [
  ...
  { code: 'MSEL', label: 'Media', category: 'Media', description: 'Open the default media player' },
  { code: 'EJCT', label: 'Eject', category: 'Media', description: 'Eject media' },
  { code: 'MFFD', label: 'Fast Fwd', category: 'Media', description: 'Fast-forward media' },
  { code: 'MRWD', label: 'Rewind', category: 'Media', description: 'Rewind media' },
  { code: 'MAIL', label: 'Mail', category: 'Media', description: 'Open the default mail application' },
  { code: 'CALC', label: 'Calc', category: 'Media', description: 'Open the calculator' },
  { code: 'MYCM', label: 'Files', category: 'Media', description: 'Open the file browser' },
  { code: 'WSCH', label: 'Search', category: 'Media', description: 'Browser search' },
  { code: 'WHOM', label: 'Web Home', category: 'Media', description: 'Browser home' },
  { code: 'WBAK', label: 'Web Back', category: 'Media', description: 'Browser back' },
  { code: 'WFWD', label: 'Web Fwd', category: 'Media', description: 'Browser forward' },
  { code: 'WSTP', label: 'Web Stop', category: 'Media', description: 'Stop loading the current page' },
  { code: 'WREF', label: 'Refresh', category: 'Media', description: 'Refresh the current page' },
  { code: 'WFAV', label: 'Favorites', category: 'Media', description: 'Open browser favorites' },
  ...
  { code: 'CAPS_WORD', label: 'Caps Word', category: 'Special', description: 'Toggle Caps Word' },
  { code: 'KEY_REPEAT', label: 'Repeat', category: 'Special', description: 'Repeat the last pressed key' },
  { code: 'GRAVE_ESCAPE', label: 'Grave Esc', category: 'Special', description: 'Escape normally, Grave when Shift or GUI is held' },
  { code: 'STUDIO_UNLOCK', label: 'Studio Unlock', category: 'Special', description: 'Unlock ZMK Studio editing' },
  { code: 'OUTPUT_USB', label: 'USB Out', category: 'Special', description: 'Select USB output' },
  { code: 'OUTPUT_BLUETOOTH', label: 'BLE Out', category: 'Special', description: 'Select Bluetooth output' },
  { code: 'PWR', label: 'Power', category: 'Special', description: 'System power down' },
  { code: 'SLEEP', label: 'Sleep', category: 'Special', description: 'System sleep' },
  { code: 'WAKE', label: 'Wake', category: 'Special', description: 'System wake' },
  { code: 'EXEC', label: 'Execute', category: 'Special' },
  { code: 'HELP', label: 'Help', category: 'Special' },
  { code: 'MENU', label: 'Menu', category: 'Special' },
  { code: 'SELECT', label: 'Select', category: 'Special' },
  { code: 'STOP', label: 'Stop', category: 'Special' },
  { code: 'AGAIN', label: 'Again', category: 'Special', description: 'Again or Redo' },
  { code: 'UNDO', label: 'Undo', category: 'Special' },
  { code: 'CUT', label: 'Cut', category: 'Special' },
  { code: 'COPY', label: 'Copy', category: 'Special' },
  { code: 'PASTE', label: 'Paste', category: 'Special' },
  { code: 'FIND', label: 'Find', category: 'Special' },
