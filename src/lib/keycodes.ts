...
export const KEYCODES: Keycode[] = [
  ...
  { code: 'MS_U', label: 'Ms Up', category: 'Media' },
  { code: 'MS_D', label: 'Ms Dn', category: 'Media' },
  { code: 'MS_L', label: 'Ms Lt', category: 'Media' },
  { code: 'MS_R', label: 'Ms Rt', category: 'Media' },
  { code: 'BTN1', label: 'Btn 1', category: 'Media' },
  { code: 'BTN2', label: 'Btn 2', category: 'Media' },
