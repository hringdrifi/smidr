...
const TARGET_KEYCODE_CATALOG: Record<KeycodeSupportTarget, ReadonlySet<string>> = {
  qmk: new Set([...CORE_KEYCODES, ...QMK_LIGHTING_KEYS, ...POINTER_KEYS, ...FIRMWARE_CONTROL_KEYS]),
  via: new Set([...CORE_KEYCODES, ...QMK_LIGHTING_KEYS, ...POINTER_KEYS, ...FIRMWARE_CONTROL_KEYS]),
  vial: new Set([...CORE_KEYCODES, ...QMK_LIGHTING_KEYS, ...POINTER_KEYS, ...FIRMWARE_CONTROL_KEYS]),
  zmk: new Set([...CORE_KEYCODES, ...ZMK_LIGHTING_KEYS, ...ZMK_POINTER_KEYS]),
  rmk: new Set([...CORE_KEYCODES, ...RMK_POINTER_KEYS, ...FIRMWARE_CONTROL_KEYS]),
};
