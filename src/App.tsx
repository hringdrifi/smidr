          ...
          {storeState.appMode !== 'remap' && (
            <div className="flex items-center bg-[var(--bg-app)]/50 rounded-lg p-0.5 border border-[var(--border-main)]">
              <button 
                ...
                className="p-1.5 hover:bg-[var(--bg-hover)] rounded disabled:opacity-20 text-[var(--text-dim)] hover:text-[var(--text-highlight)] transition-all"
                title={t('header.undo')}
              >
                <Undo2 size={16} />
              </button>
                ...
                <>
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold text-[var(--text-highlight)] uppercase tracking-wider">
                      {connectedDevice.productName || 'Keyboard'}
                    </span>
                  </div>
                  ...
                  className={cn(
                    ...
                    storeState.isProjectOpen && showSavedFeedback
                      ...
                      : storeState.isProjectOpen && isDirty 
                        ...
                        : cn(
                            "bg-[var(--bg-app)]/50 border border-[var(--border-main)] hover:bg-[var(--bg-hover)]",
                            storeState.isProjectOpen ? "text-[var(--text-dim)] hover:text-[var(--text-highlight)]" : "text-[var(--text-main)]"
                          ),
