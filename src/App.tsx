              ...
              <>
                ...
                <div className="absolute top-4 right-4 z-[100] flex flex-col gap-4 items-end">
                  ...
                  {openMacroPanel && openMacroPanelMeta && (
                    <div
                      className="absolute top-4 right-20 w-80 z-[130] bg-[var(--bg-panel)]/95 backdrop-blur-xl border border-[var(--border-main)] rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col animate-in fade-in slide-in-from-right-8 duration-300 transition-all duration-300"
                      style={{
                        bottom: editorMode === 'keymap' ? '416px' : (editorMode === 'layout' || editorMode === 'matrix') ? '304px' : '16px'
                      }}
                    >
